...
export const breadcrumb = style({ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '11px' })
...
export const clock = style({ color: vars.color.gray.main, fontSize: '10px', whiteSpace: 'nowrap', '@media': { '(max-width: 520px)': { display: 'none' } } })
...
export const avatar = style({ display: 'grid', placeItems: 'center', width: '26px', height: '26px', padding: 0, border: 0, borderRadius: '50%', background: vars.color.base.black, color: vars.color.base.white, cursor: 'pointer', fontSize: '9px', fontWeight: 600 })
